...
namespace LibraryApi.Controllers
{
    public class ReservationsController : ControllerBase
    {
        ...
        public async Task<ActionResult> DenyReservation([FromBody] Reservations reservation)
        {
        ...
        public async Task<ActionResult> ApproveReservation([FromBody] Reservations reservation)
        {
            var storedReservation = await Context.Reservations.SingleOrDefaultAsync(r => r.Id == reservation.Id);
            if (storedReservation == null)
            {
